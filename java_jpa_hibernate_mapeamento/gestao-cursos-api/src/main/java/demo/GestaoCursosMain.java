...
public class GestaoCursosMain {
    ...
    public static void main(String[] args) {
        ...
        end1.setEndereco("Marly Figueiredo");
        end1.setNumero("683");
        end1.setBairro("Casa Caiada");
        end1.setCidade("Olinda");
        end1.setEstado("Pernambuco");
        end1.setCep(38408000);

        Endereco end2 = new Endereco();
        end2.setLogradouro("Avenida");
        end2.setEndereco("Boa Viagem");
        end2.setNumero("90");
        end2.setBairro("Boa Viagem");
        ...
        updateAlunoId1.setNomeCompleto("Maria Gracilane Araújo da Silva");
        updateAlunoId1.getTelefones().forEach(telefone -> {
            if(telefone.getId() == 1L)
                telefone.setNumero("99106-9239");
        });
        ...
        prof1.setNomeCompleto("Roberto");
        prof1.setMatricula("PROF-01");
        prof1.setEmail("roberto@prof.com");
